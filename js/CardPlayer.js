...
export default class CardPlayer extends CardDraggable {
    constructor(data) {
        ...
        this.textArmor = new Phaser.GameObjects.BitmapText(this.scene, 0, -102, 'pressstart'); // No initial value for initial armor, otherwise we can set zero
        ...
        this.add([this.textHealth, this.textMaxHealth, this.spriteArmor, this.textArmor]); // Write text over armor sprite
        this.health = health;
